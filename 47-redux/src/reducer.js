...
import calcReducers from './reducers/calculations'
...
function reducer(state = defaultState, action) {
    ...
    switch (action.type) {
        ...
        default:
            calcReducers.forEach(calcReducer => {
                if (calcReducer.action === action.type) {
                    state = calcReducer.callback(state, action)
                }
            })
            return state
    }
