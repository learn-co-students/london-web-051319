...
import { Container, Dropdown, Checkbox, Button, Segment, Label } from 'semantic-ui-react'
      ...
      <Container>
        ...
        <Segment>
          <Dropdown
            ...
            options={Object.values(SORT_OPTIONS).map(key => ({ text: `Sort by: ${key}`, key, value: key }))}
